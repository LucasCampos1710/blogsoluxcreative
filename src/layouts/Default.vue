      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/">
            <g-image src="../../static/Logo-Solux-Creative-Color.png" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/">
            <g-image src="../../static/Logo-Solux-Creative-Branco.png" class="w-40" alt="logo" />
          </g-link>
        </div>
        ...
        >
          ...
          <li>
            <g-link to="/omni" class="text-copy-primary hover:text-gray-600">Solux Omni</g-link>
          </li>
          <li>
            <a
              v-if="$route.path === '/'"
          ...
          <li>
            <g-link
              to="/profile"
              class="text-copy-primary hover:text-gray-600"
            >{{ isAuthenticated ? 'Profile' : 'Login' }}</g-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-green-700 text-white">
      ...
      >
        <div class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. All rights reserved Solux Creative. v.0.0.1</div>
          <!-- <div>
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:contato@soluxcreative.com.br" class="text-white hover:text-gray-400">
          ...
          <li>
            <a
              href="https://github.com/lucascampos1710"
              target="_blank"
          ...
          <li>
            <a
              href="https://twitter.com/herve76"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
          ...
          <li>
            <a
              href="https://instagram.com/soluxcreative"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
